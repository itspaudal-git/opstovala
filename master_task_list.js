    ...
    function displayTable(data) {
        ...
        sortedData.forEach((entry, index) => {
            ...
            row.innerHTML = `
                ...
                <td contenteditable="true" class="equipment-select">${entry.Equipment || ''}</td>
                <td contenteditable="true" class="project-hours">${parseFloat(entry["Project Hours"] || 0).toFixed(2)}</td>
                <td contenteditable="true" class="man-hours">${parseFloat(entry["Man Hours"] || 0).toFixed(2)}</td>
